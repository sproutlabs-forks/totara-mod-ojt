...
$formdata = null;
$mform = new import_completions_form($PAGE->url->out(), array('data' => $data, 'options' => $file_picker_options));
...
if ($mform->is_cancelled()) {
    ...
    $result = mod_ojt_plugin::import_completion_file($COURSE, array_shift($area_files));
